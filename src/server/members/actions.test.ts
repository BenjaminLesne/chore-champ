...
void describe("members/actions exports", () => {
  void it("exports createMember, updateMember, deleteMember", async () => {
    ...
    if (mod) {
      assert.strictEqual(typeof mod.createMember, "function");
      assert.strictEqual(typeof mod.updateMember, "function");
      assert.strictEqual(typeof mod.deleteMember, "function");
    } else {
